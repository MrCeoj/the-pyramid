...
const PendingMatchCard = ({
  ...
  return (
    <>
        ...
        <div className="flex gap-3">
          <div className="relative group flex-1">
            <button
              ...
              className="w-full px-4 py-2 bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 hover:text-white rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            {rejectedAmount >= 2 && (
              <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 text-sm text-white bg-slate-800 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
      ...
      {/* Mobile modal */}
      {showRejectModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-indor-black/50 backdrop-blur-lg text-white z-50">
          <div className="bg-gray-800 border border-black rounded-xl p-6 max-w-sm w-auto text-center">
